...
class Database extends Autobase {
  ...
  /**
   * Retrieves all documents and organizes them into a tree structure.
   * @returns {Promise<{ tree: object, tags: object, documents: object }>}
   * A promise that resolves to an object containing the tree, tags, and documents.
   */
